...
# $BUILDPLATFORM: run node natively on the build host regardless of target arch.
# The output (static JS/CSS) is architecture-independent; running node under
# QEMU emulation on the arm64 leg is slow and prone to libuv/V8 deadlocks.
