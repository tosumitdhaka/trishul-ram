...
- [ ] Verify Docker image pushed: `ghcr.io/OWNER/tram:X.Y.Z`
- [ ] Verify Helm chart pushed: `oci://ghcr.io/OWNER/charts/tram:X.Y.Z`
...
#### 2. Verification
- [ ] Test pull image: `docker pull ghcr.io/OWNER/tram:X.Y.Z`
- [ ] Test Helm install:
  ```bash
  helm install tram oci://ghcr.io/OWNER/charts/tram --version X.Y.Z --dry-run
  ```
...
- [ ] Update Helm deployments:
  ```bash
  helm upgrade tram oci://ghcr.io/OWNER/charts/tram --version X.Y.Z-1
  ```
